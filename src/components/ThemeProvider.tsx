...
interface DarkModeContextType {
  brightnessPreference: string
  setBrightnessPreference: (v: string) => void
}
...
const DarkModeToggle: FC = () => {
  ...
  const { brightnessPreference, setBrightnessPreference } = context
...
const AppThemeProvider: FC<AppThemeProviderProps> = ({ children }) => {
  ...
  const theme = React.useMemo(() => {
    const effectiveModes: Record<string, "light" | "dark"> = {
      light: "light",
      dark: "dark",
  ...
  return (
    ...
    >
      <ScThemeProvider theme={theme as unknown as import("styled-components").DefaultTheme}>
